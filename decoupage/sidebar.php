 ...
 <div class="list-group text-start my-list mb-5">
    ...
    <a href="" class="mt-2 p-2 "><i class=" icon fas fa-signal text-info fs-4 ps-3 pe-3  "></i><input type="button" value="statistics" class=" text-capitalize bg-transparent txt d-none d-lg-inline-block fs-6"></a>
